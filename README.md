...
2. clone with this command `git clone https://github.com/aubinleyoung/School-library-app.git`
3. cd School-library-app
4. Make sure Ruby is installed on your computer.
...
Feel free to check the [issues page](https://github.com/aubinleyoung/School-library-app/issues).
